...
const visualReaction =  document.createElement('button');
visualReaction.innerHTML = 'VISUAL REACTION TASK';
visualReaction.className ="pageOptions";
visualReaction.id ="visualReaction";
visualReaction.addEventListener('click',()=>{
    window.open("/Users/lordyolo/Desktop/website/sitemap/neuropsychology/reaction/visualReactionTask/visualReactionTask.html");
});
optionsDisplay.appendChild(visualReaction);

const auditoryReactionTask =  document.createElement('button');
auditoryReactionTask.innerHTML = 'AUDITORY REACTION TASK';
auditoryReactionTask.className ="pageOptions";
auditoryReactionTask.id ="auditoryReactionTask";
auditoryReactionTask.addEventListener('click',()=>{
    window.open("/Users/lordyolo/Desktop/website/sitemap/neuropsychology/reaction/sonicReactionTask/sonicReactionTask.html");
});
optionsDisplay.appendChild(auditoryReactionTask);
