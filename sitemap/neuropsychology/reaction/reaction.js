...
visualReaction.addEventListener('click',()=>{
    window.open("sitemap/neuropsychology/reaction/visualReactionTask/visualReactionTask.html");
});
...
auditoryReactionTask.addEventListener('click',()=>{
    window.open("sitemap/neuropsychology/reaction/sonicReactionTask/sonicReactionTask.html");
});
