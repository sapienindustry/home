...
colourPerception.addEventListener('click',()=>{
    function link(){
        var a = document.createElement('a');
        a.href="sitemap/neuropsychology/perception/ colourPerceptionTask/colourPerception.html";
        a.click()
    };
...
audiometer.addEventListener('click',()=>{
    function link(){
        var a = document.createElement('a');
        a.href="sitemap/neuropsychology/perception/audiometer/audiometer.html";
        a.click();
    };
        windowOpen(container);
        setTimeout(link,1500)});
